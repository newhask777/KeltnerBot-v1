...
def calculate_adx(df, period=14):
    ...
    data['smoothed_plus_dm'] = data['plus_dm'].rolling(window=period).mean()
    data['smoothed_minus_dm'] = data['minus_dm'].rolling(window=period).mean()
...
if __name__ == "__main__":
    ...
    symbol = 'DOGEUSDT'
    timeframe = 240  # Дневной таймфрейм
